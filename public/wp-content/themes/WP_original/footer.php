...
<footer>
	<div class="f_share_btn">
		<ul>
			<!-- <li><a href="https://twitter.com/et_web_tokyo"><img src="<?php bloginfo('template_url'); ?>/assets/img/sns/twitter_out.png" alt="twitter" width="50"></a></li>
			<li><a href="https://www.facebook.com/sept.eleven.jpn"><img src="<?php bloginfo('template_url'); ?>/assets/img/sns/fb_out.png" alt="facebook" width="50"></a></li> -->
